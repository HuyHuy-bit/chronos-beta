...
.PHONY: help doctor config-check smoke synth-smoke foundation-check model-check raw-check snapshot-check compact-check control-check retention-check registers-check check
...
check: foundation-check model-check raw-check snapshot-check compact-check control-check retention-check registers-check
