...
.PHONY: help doctor config-check smoke synth-smoke foundation-check model-check raw-check snapshot-check compact-check check
...
help:
	...
	@printf '%s\n' 'snapshot-check    Check P1c retention and authoritative model snapshots' 'compact-check     Check P1d exact-time codecs and framed size comparisons'
...
check: foundation-check model-check raw-check snapshot-check compact-check
